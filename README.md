...
| -------                                                              | -------   | ----------------- | ----------------- |
| [Fermitools](https://github.com/fermi-lat/Fermitools-conda/wiki)     | 2.5.1     | fermi             | Basic tools necessary to analyze Fermi data|
| [Fermipy](https://fermipy.readthedocs.io/en/latest/)                 | 1.4.1     | fermi             | Python package that facilitates analysis of LAT data with the Fermi Science Tools |
